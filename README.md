...
- Migrations up: `make migrate-up DATABASE_URL="postgres://gatify:your_password@localhost:5432/gatify?sslmode=disable"`
- Migration version: `make migrate-version DATABASE_URL="postgres://gatify:your_password@localhost:5432/gatify?sslmode=disable"`
